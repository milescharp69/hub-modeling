...
copyDefinedHubs = copy.deepcopy(Hub_Urban_Community)
...
def app():
    ...
    class_c_mix = classmixexpander.slider('Vehicle Class C Mix', 0.0, 1.0, float(Hub_Vehicle_Mix[2]), step=0.05,
                                          key= "class_c_slider", on_change=changedeltaC, args=(float(Hub_Vehicle_Mix[2]), )
    )
    ...
    metric_container_info_col1.metric("Usage 7am-10pm", Hub_Urban_Community.Notional_Loading[0], pagedata.usageAdelta)
    metric_container_info_col2.metric("Usage 10pm-7am", Hub_Urban_Community.Notional_Loading[1], pagedata.usageBdelta)
    ...
    maincol2expander.markdown("<p style='text-align: center; color: black; font-size: 25px;'>{}</p>".format(Hub_Urban_Community.Peak_kW()), unsafe_allow_html=True)
    ...
    if pagedata.usageAdelta != 0 or pagedata.usageBdelta != 0 or pagedata.classAMixdelta != 0 or pagedata.classBMixdelta != 0 or pagedata.classCMixdelta != 0:
        ...
        BARGRAPH_seriesdata = [{
            ...
            "data": [Hub_Urban_Community.Vehicles_Serviced_Per_Month_By_Class(0),
        ...
        },
            {
                ...
                "data": [Hub_Urban_Community.Vehicles_Serviced_Per_Month_By_Class(1),
            ...
            },
            {
                ...
                "data": [Hub_Urban_Community.Vehicles_Serviced_Per_Month_By_Class(2),
